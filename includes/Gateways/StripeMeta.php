...
class MinSponsor_StripeMeta {
    ...
    public function init() {
        ...
        add_filter('wc_stripe_payment_intent_args', array($this, 'add_payment_intent_metadata'), 10, 2);
        add_filter('wc_stripe_setup_intent_args', array($this, 'add_setup_intent_metadata'), 10, 2);
        
        // For subscription renewals
        add_filter('woocommerce_stripe_subscription_payment_intent_args', array($this, 'add_subscription_payment_metadata'), 10, 3);
        
        // Alternative hook names that might be used by different versions
        add_filter('wc_stripe_payment_request_args', array($this, 'add_payment_request_metadata'), 10, 2);
    }
     ...
     */
    public function add_payment_intent_metadata($args, $order) {
     ...
     * @return array Modified arguments
     */
    public function add_setup_intent_metadata($args, $order) {
     ...
     * @return array Modified arguments
     */
    public function add_subscription_payment_metadata($args, $subscription, $order) {
     ...
     * @return array Modified arguments
     */
    public function add_payment_request_metadata($args, $order) {
        return $this->add_payment_intent_metadata($args, $order);
    }
     ...
     * @return bool
     */
    public static function is_stripe_available() {
     ...
     * @param WC_Order $order Order object
     */
    public function update_stripe_customer_metadata($order) {
